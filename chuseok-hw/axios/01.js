...
// async function getSingleProduct(n) {
//   const res = await axios.get(`https://dummyjson.com/products/${n}`);
//   const data = res.data;
//   console.log(data);
// }
...
// async function getSearchPosts(s) {
//   const res = await axios.get(`https://dummyjson.com/posts/search?q=${s}`);
//   const data = res.data;
//   console.log(data);
// }
...
// async function getSearchPostsArray(s) {
//   const res = await axios.get(`https://dummyjson.com/posts/search?q=${s}`);
