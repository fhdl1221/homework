...
function getUsersByCity(obj, name) {
  const newArr = obj.filter((element) => {
...
function getLongestStringLength(arr) {
  let max = 0;
  for (const e of arr) {
...
function extractProperty(arr, value) {
